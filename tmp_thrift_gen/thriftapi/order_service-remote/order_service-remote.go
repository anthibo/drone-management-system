...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  Order SubmitOrder(SubmitOrderRequest request)")
	fmt.Fprintln(os.Stderr, "  Order WithdrawOrder(OrderIDRequest request)")
	fmt.Fprintln(os.Stderr, "  OrderView GetOrder(OrderIDRequest request)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := thriftapi.NewOrderServiceClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "SubmitOrder":
		if flag.NArg() - 1 != 1 {
			fmt.Fprintln(os.Stderr, "SubmitOrder requires 1 args")
			flag.Usage()
		}
		arg34 := flag.Arg(1)
		...
		argvalue0 := thriftapi.NewSubmitOrderRequest()
		...
		value0 := argvalue0
		fmt.Print(client.SubmitOrder(context.Background(), value0))
		fmt.Print("\n")
		break
	case "WithdrawOrder":
		if flag.NArg() - 1 != 1 {
			fmt.Fprintln(os.Stderr, "WithdrawOrder requires 1 args")
			flag.Usage()
		}
		arg40 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.WithdrawOrder(context.Background(), value0))
		fmt.Print("\n")
		break
	case "GetOrder":
		if flag.NArg() - 1 != 1 {
