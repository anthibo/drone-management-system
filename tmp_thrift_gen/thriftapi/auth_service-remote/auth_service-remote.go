...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  TokenResponse IssueToken(TokenRequest request)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := thriftapi.NewAuthServiceClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "IssueToken":
		if flag.NArg() - 1 != 1 {
			fmt.Fprintln(os.Stderr, "IssueToken requires 1 args")
			flag.Usage()
		}
		arg8 := flag.Arg(1)
		...
		argvalue0 := thriftapi.NewTokenRequest()
		...
		value0 := argvalue0
		fmt.Print(client.IssueToken(context.Background(), value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
